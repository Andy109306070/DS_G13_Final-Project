...
%>
	...
	<div>
		<a href ='http://localhost:8080/DS_project/Search.jsp'><img src="images/bone.png"
			style='position: absolute; width: 150px; height: 100px; left: 50%; top: 50%; margin-top: -280px; margin-left: -590px'></a>
	</div>
		<div>
